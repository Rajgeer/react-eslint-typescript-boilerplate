  ...
  return (
    <header className="bg-white">
      ...
      >
        ...
        <button type="button" onClick={toggle} className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false">
          Product
        ...
        {openDropdown&&<div className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
          <div className="p-4">
